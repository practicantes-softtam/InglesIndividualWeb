<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="Lecciones.aspx.cs" Inherits="InglesIndividual.Web.Lecciones" %>
    ...
    <script type="text/javascript">
        ...
        var settings = {
            source: {
                ...
                url: 'Lecciones.aspx/GetData'
            },
            gridOptions: {
                columns: [
                        { text: 'Clave', dataField: 'Clave', width: 100, cellsrenderer: renderEdit },
                        { text: 'Lecciones', dataField: 'Nombre', width: 300 },
                ...
                formatData: function (data) {
                    if (data.sortdatafield != undefined && data.sortdatafield != null) {
                        switch (data.sortdatafield) {
                            case "Clave": data.sortdatafield = "ClaLeccion"; break;
                            case "Nombre": data.sortdatafield = "NomLeccion"; break;
                        }
                    }
                    var p1 = $("#param1").val();
                    $.extend(data, {
        ...
        $(document).ready(function () {
            ...
            $("#mainForm").jqxValidator({
                rules: [
                { input: "#uiNombre", message: "El nombre de la Lección es requerido", rule: "required" }
            ]
            });
        ...
        function configurarCombo() {
            var url = "Lecciones.aspx/PruebaCombo";
            // prepare the data
            var src =
            {
                datatype: "json",
