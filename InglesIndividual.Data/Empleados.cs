    ...
    public class Empleados : InglesIndividualDataObject
    {
        public List<Entities.Empleados> ListarEmpleados(InglesIndividual.Entities.JQXGridSettings settings, string nombre)
        {
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                item.ClaPuesto = new Entities.Puestos();
                item.ClaPuesto.ClaPuesto = Utils.GetDataRowValue(dr, "ClaPuesto", 0);
                ...
                item.Ciudad = new Entities.Ciudades();
        ...
        public override int Insert(Entity entity, DataTransaction tran)
        {
            ...
            sp.ClaPuesto = item.ClaPuesto.ClaPuesto;
            sp.Calle = item.Calle;
